...
#define DHTPIN 13         // Chân digital kết nối với cảm biến DHT11 (thay D2 bằng GPIO13)
#define DHTTYPE DHT11     // Loại cảm biến DHT (DHT11)
#define MQ2PIN 34         // Chân analog kết nối với cảm biến MQ2 (thay A0 bằng GPIO34)
#define FIREPIN 23        // Chân digital kết nối với cảm biến cháy (thay D3 bằng GPIO23)
#define FIREPIN_1 22

DHT dht(DHTPIN, DHTTYPE);
LoRa_E32 e32ttl(&Serial2, 5, 19, 18);
     ...
     int flame2 = digitalRead(FIREPIN_1);   // Cảm biến lửa mới
        ...
        if (flame1 == LOW || flame2 == LOW) {
          *(short*)message.flameVal = 1; // Có lửa     
          // Gửi thông báo cho Master về tình trạng khẩn cấp
          Serial.println("Fire detected! Sending alert to Master...");
